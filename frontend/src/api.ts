...
function calculateClientCorridor(
  ...
  const recommendations = [
    tier1 === 'Unmonitored' && `Coverage Notice: Departure terminal '${originLoc.location_name}' is currently unmonitored; verify local regional advisory.`,
    tier2 === 'Unmonitored' && `Coverage Notice: Arrival terminal '${destLoc.location_name}' is currently unmonitored; verify local regional advisory.`,
